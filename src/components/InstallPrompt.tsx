...
export function InstallPrompt() {
  ...
  return (
    <div className="no-print fixed inset-x-0 bottom-[4.5rem] z-50 mx-auto max-w-lg px-3">
      <div className="flex items-center gap-3 rounded-2xl border border-teal-200 bg-white p-3 shadow-xl">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-teal-50 text-teal-600">
          <Download className="h-5 w-5" />
        </div>
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-slate-800">Instalar o SBAR Médico</p>
          {deferred ? (
            <p className="text-xs text-slate-500">Acesso rápido e uso offline.</p>
          ) : (
